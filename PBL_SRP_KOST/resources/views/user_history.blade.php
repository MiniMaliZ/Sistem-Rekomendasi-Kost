        ...
        <section id="section-sidebar">
            <nav class="nav-pill">
                <ul class="nav-list">
                    ...
                    <li>
                        <a href="#" class="nav-item" aria-label="Favorites">
                            <x-solar-heart-linear class="nav-blade-icon" />
                        </a>
                    </li>
                    <li>
                        <a href="#" class="nav-item nav-item--active" aria-label="History">
            ...
            <button class="logout-button" aria-label="Logout">
                <x-iconsax-out-logout class="nav-blade-icon nav-blade-icon--logout" />
            </button>
        </section>
