...
<body>
    <div class="auth-wrapper">
        ...
        <div class="auth-form-panel">
            <div class="auth-form-inner">
                ...
                <p class="auth-subheading">Masuk untuk melanjutkan pencarian kost terbaikmu</p>
                ...
                <form method="POST" action="{{ route('login') }}" class="auth-form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-password-wrap">
                            ...
                            <button type="button" class="toggle-password" onclick="togglePassword('password', this)" tabindex="-1" aria-label="Tampilkan password">
                                {{-- mata terbuka: tampil saat password TERLIHAT --}}
                                ...
                                {{-- mata dicoret: tampil saat password TERSEMBUNYI (default) --}}
                    ...
                    <p class="auth-switch">
                        Belum punya akun?
                        <a href="{{ route('register') }}" class="auth-switch-link">Daftar</a>
                    </p>
                </form>
    ...
    <script>
        function togglePassword(inputId, btn) {
            ...
            // Saat password terlihat (isHidden=true): tampilkan icon-eye, sembunyikan icon-eye-off
            // Saat password tersembunyi (isHidden=false): sembunyikan icon-eye, tampilkan icon-eye-off
